// App Studio — Client half.
// A floating action button + draggable panel with a same-origin preview iframe,
// an editing bridge (postMessage), a property panel, and an AI streaming editor.
...
export function apply(ctx) {
  ...
  // Inject package-owned styles, removed on dispose.
  const STYLE_ID = 'dsh-app-studio-style'
  let styleTag
